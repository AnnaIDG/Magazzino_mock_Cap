...
utils.Validator = {
    tel_fax: function(control) {
        ...
        if (!val.match(telFaxRegex)) {
            ...
            control.setValueStateText(this.T.getText("TEL_FAX_INVALID"));
            return false;
        }
    ...
    email: function(control) {
        ...
        if (!val.match(mailregex)) {
            ...
            control.setValueStateText(this.T.getText("EMAIL_INVALID"));
            return false;
        }
        control.setValueState("Success");
        return true;
    ...
    passwords: function(control1, control2) {
        ...
        if (val1 !== val2 || val1 === "" && val2 === "") {
            ...
            control2.setValueStateText(this.T.getText("PASS_NO_MATCH"));
            return;
        }
