...
utils.UserSerializer = {
	...
	user: {
		...
		fromSap : function(sapData) {
			...
			u.Xaltrodest = sapData.Xaltrodest ? sapData.Xaltrodest : "";
			u.Xcantiere = sapData.Xcantiere ? sapData.Xcantiere : "";
			u.Xcustomers = sapData.Xcustomers ? sapData.Xcustomers : "";
			u.Xorders = sapData.Xorders ? sapData.Xorders : "";
    ...
    UserType : 
    {
		...
		fromSap : function(sapData) {
            ...
            uTyp.id = sapData.id ? sapData.id : "";
            uTyp.typeDescription = sapData.idText ? sapData.idText : "";
